...
public class MqttSubscribe implements MqttCallback, Runnable{
	...
	public void subscribe() {
		try {
			...
			MqttClient client = new MqttClient(address, "experimentoG", m);
	...
	public Message encapsuleMessage(String m, long time) {
		// type=air;resource=10;message=1000;REP=1;EXP=1;P1=1504201346843;
		String[] msg = m.split(";");
		int i = 0;
